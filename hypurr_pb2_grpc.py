...
class StaticStub(object):
  ...
  def __init__(self, channel):
    ...
    self.HyperliquidTokenHolders = channel.unary_unary(
        ...
        request_serializer=hypurr__pb2.HyperliquidTokenHoldersRequest.SerializeToString,
        response_deserializer=hypurr__pb2.HyperliquidTokenHoldersResponse.FromString,
        )
    ...
    self.HypurrFunCabals = channel.unary_unary(
        ...
        request_serializer=hypurr__pb2.HypurrFunCabalsRequest.SerializeToString,
        response_deserializer=hypurr__pb2.HypurrFunCabalsResponse.FromString,
        )
...
def add_StaticServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'HyperliquidTokenHolders': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=hypurr__pb2.HyperliquidTokenHoldersRequest.FromString,
          response_serializer=hypurr__pb2.HyperliquidTokenHoldersResponse.SerializeToString,
      ),
      ...
      'HypurrFunCabals': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=hypurr__pb2.HypurrFunCabalsRequest.FromString,
          response_serializer=hypurr__pb2.HypurrFunCabalsResponse.SerializeToString,
      ),
