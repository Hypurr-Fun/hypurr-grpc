...
type HyperliquidLaunchPosition struct {
	...
	Pnl     int64  `protobuf:"varint,3,opt,name=pnl,proto3" json:"pnl,omitempty"`
}
...
func (x *HyperliquidLaunchPosition) GetPnl() int64 {
	if x != nil {
		return x.Pnl
	}
	return 0
...
var file_hypurr_proto_rawDesc = []byte{
	...
	0x6e, 0x52, 0x09, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x61, 0x0a, 0x19,
	...
	0x03, 0x70, 0x6e, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x70, 0x6e, 0x6c, 0x22,
