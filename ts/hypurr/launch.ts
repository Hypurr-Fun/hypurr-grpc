...
class HyperliquidLaunch$Type extends MessageType<HyperliquidLaunch> {
    constructor() {
        super("hypurr.HyperliquidLaunch", [
            ...
            { no: 15, name: "fills", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => HyperliquidLaunchFill },
    ...
    create(value?: PartialMessage<HyperliquidLaunch>): HyperliquidLaunch {
        ...
        message.k = 0;
        message.fills = [];
        message.dailyNtlVolume = 0;
        message.previousDayPx = 0;
        message.lastEventTimestamp = 0;
        message.poolType = 0;
        message.decimals = 0;
        message.mediaType = "";
        message.listedTimestamp = 0;
        message.devLockup = "0";
