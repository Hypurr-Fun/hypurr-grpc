...
// @generated from protobuf file "hypurr/evm/evm_service.proto" (package "hypurr", syntax proto3)
// tslint:disable
...
class ERC20TokensResponse$Type extends MessageType<ERC20TokensResponse> {
    constructor() {
        super("hypurr.ERC20TokensResponse", [
            { no: 1, name: "tokens", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ERC20Token },
...
class UniPairsResponse$Type extends MessageType<UniPairsResponse> {
    constructor() {
        super("hypurr.UniPairsResponse", [
            { no: 1, name: "pairs_v2", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => UniV2Pair },
            { no: 2, name: "pairs_v3", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => UniV3Pool },
...
class UniV2SwapsResponse$Type extends MessageType<UniV2SwapsResponse> {
    constructor() {
        super("hypurr.UniV2SwapsResponse", [
            { no: 1, name: "swaps", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => UniV2Swap },
            { no: 2, name: "next_page_token", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
class ERC20TransferEventsResponse$Type extends MessageType<ERC20TransferEventsResponse> {
    constructor() {
        super("hypurr.ERC20TransferEventsResponse", [
            { no: 1, name: "events", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ERC20TransferEvent },
            { no: 2, name: "next_page_token", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
class ERC20ApprovalEventsResponse$Type extends MessageType<ERC20ApprovalEventsResponse> {
    constructor() {
        super("hypurr.ERC20ApprovalEventsResponse", [
            { no: 1, name: "events", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ERC20ApprovalEvent },
            { no: 2, name: "next_page_token", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
class UniV3SwapsResponse$Type extends MessageType<UniV3SwapsResponse> {
    constructor() {
        super("hypurr.UniV3SwapsResponse", [
            { no: 1, name: "swaps", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => UniV3Swap },
            { no: 2, name: "next_page_token", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
class ERC20AccountBalancesResponse$Type extends MessageType<ERC20AccountBalancesResponse> {
    constructor() {
        super("hypurr.ERC20AccountBalancesResponse", [
            { no: 1, name: "account_balances", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ERC20AccountBalance }
        ]);
    }
