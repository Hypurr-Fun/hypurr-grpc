...
class HyperliquidWallet$Type extends MessageType<HyperliquidWallet> {
    constructor() {
        super("hypurr.HyperliquidWallet", [
            ...
            { no: 18, name: "positions", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => HyperliquidWalletPosition }
        ]);
    }
    create(value?: PartialMessage<HyperliquidWallet>): HyperliquidWallet {
        const message = { id: 0, name: "", ethereumAddress: "", points: 0, movements: [], spotBalances: [], launchBalances: [], isAgent: false, isReadOnly: false, scaleSessions: [], twapSessions: [], public: false, isSubaccount: false, perpBalance: 0, positions: [] };
...
class HyperliquidWalletPosition$Type extends MessageType<HyperliquidWalletPosition> {
    ...
    create(value?: PartialMessage<HyperliquidWalletPosition>): HyperliquidWalletPosition {
        const message = { walletId: 0, instrumentId: 0, dex: "", size: 0, entryPrice: 0, allTimeFunding: 0, funding: 0, positionMargin: 0, leverageType: "", leverageValue: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
