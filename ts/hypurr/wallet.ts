...
export interface HyperliquidWallet {
    ...
    /**
     * @generated from protobuf field: double perp_balance = 17
     */
    perpBalance: number;
    /**
...
/**
 * @generated from protobuf message hypurr.HyperliquidWalletPosition
 */
export interface HyperliquidWalletPosition {
    ...
    walletId: number;
    /**
     * @generated from protobuf field: int64 instrument_id = 3
     */
    instrumentId: number;
    /**
     * @generated from protobuf field: string dex = 4
     */
    dex: string;
    /**
     * @generated from protobuf field: double size = 5
     */
    size: number;
    /**
    ...
    entryPrice: number;
    /**
     * @generated from protobuf field: double all_time_funding = 7
     */
    allTimeFunding: number;
    /**
     * @generated from protobuf field: double funding = 8
     */
    funding: number;
    /**
     * @generated from protobuf field: double position_margin = 9
     */
    positionMargin: number;
    /**
     * @generated from protobuf field: string leverage_type = 10
     */
    leverageType: string;
    /**
     * @generated from protobuf field: double leverage_value = 11
     */
...
class HyperliquidWallet$Type extends MessageType<HyperliquidWallet> {
    constructor() {
        super("hypurr.HyperliquidWallet", [
            ...
            { no: 6, name: "movements", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => HyperliquidWalletMovement },
            { no: 7, name: "spot_balances", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => HyperliquidWalletBalance },
            { no: 8, name: "launch_balances", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => HyperliquidLaunchBalance },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* bool is_subaccount */ 16:
                    ...
                    break;
                case /* double perp_balance */ 17:
                    message.perpBalance = reader.double();
                    break;
    ...
    internalBinaryWrite(message: HyperliquidWallet, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* double perp_balance = 17; */
        if (message.perpBalance !== 0)
            writer.tag(17, WireType.Bit64).double(message.perpBalance);
...
// @generated message type with reflection information, may provide speed optimized methods
class HyperliquidWalletPosition$Type extends MessageType<HyperliquidWalletPosition> {
    constructor() {
        super("hypurr.HyperliquidWalletPosition", [
            { no: 1, name: "telegram_id", kind: "message", T: () => Int64Value },
            { no: 2, name: "wallet_id", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ },
            { no: 3, name: "instrument_id", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ },
            { no: 4, name: "dex", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 5, name: "size", kind: "scalar", T: 1 /*ScalarType.DOUBLE*/ },
            { no: 6, name: "entry_price", kind: "scalar", T: 1 /*ScalarType.DOUBLE*/ },
            { no: 7, name: "all_time_funding", kind: "scalar", T: 1 /*ScalarType.DOUBLE*/ },
            { no: 8, name: "funding", kind: "scalar", T: 1 /*ScalarType.DOUBLE*/ },
            { no: 9, name: "position_margin", kind: "scalar", T: 1 /*ScalarType.DOUBLE*/ },
            { no: 10, name: "leverage_type", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 11, name: "leverage_value", kind: "scalar", T: 1 /*ScalarType.DOUBLE*/ }
        ]);
    }
    create(value?: PartialMessage<HyperliquidWalletPosition>): HyperliquidWalletPosition {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.walletId = 0;
        ...
        message.allTimeFunding = 0;
        message.funding = 0;
        message.positionMargin = 0;
        message.leverageType = "";
        message.leverageValue = 0;
        if (value !== undefined)
            reflectionMergePartial<HyperliquidWalletPosition>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: HyperliquidWalletPosition): HyperliquidWalletPosition {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* double entry_price */ 6:
                    ...
                    break;
                case /* double all_time_funding */ 7:
                    message.allTimeFunding = reader.double();
                    break;
                case /* double funding */ 8:
                    message.funding = reader.double();
                    break;
                case /* double position_margin */ 9:
                    message.positionMargin = reader.double();
                    break;
                case /* string leverage_type */ 10:
                    message.leverageType = reader.string();
                    break;
                case /* double leverage_value */ 11:
                    message.leverageValue = reader.double();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: HyperliquidWalletPosition, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* google.protobuf.Int64Value telegram_id = 1; */
        if (message.telegramId)
            Int64Value.internalBinaryWrite(message.telegramId, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* int64 wallet_id = 2; */
        ...
        if (message.instrumentId !== 0)
            writer.tag(3, WireType.Varint).int64(message.instrumentId);
        /* string dex = 4; */
        if (message.dex !== "")
            writer.tag(4, WireType.LengthDelimited).string(message.dex);
        /* double size = 5; */
        if (message.size !== 0)
            writer.tag(5, WireType.Bit64).double(message.size);
        /* double entry_price = 6; */
        if (message.entryPrice !== 0)
            writer.tag(6, WireType.Bit64).double(message.entryPrice);
        /* double all_time_funding = 7; */
        if (message.allTimeFunding !== 0)
            writer.tag(7, WireType.Bit64).double(message.allTimeFunding);
        /* double funding = 8; */
        if (message.funding !== 0)
            writer.tag(8, WireType.Bit64).double(message.funding);
        /* double position_margin = 9; */
        if (message.positionMargin !== 0)
            writer.tag(9, WireType.Bit64).double(message.positionMargin);
        /* string leverage_type = 10; */
        if (message.leverageType !== "")
            writer.tag(10, WireType.LengthDelimited).string(message.leverageType);
        /* double leverage_value = 11; */
        if (message.leverageValue !== 0)
            writer.tag(11, WireType.Bit64).double(message.leverageValue);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message hypurr.HyperliquidWalletPosition
 */
export const HyperliquidWalletPosition = new HyperliquidWalletPosition$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
class HyperliquidWalletDeploySession$Type extends MessageType<HyperliquidWalletDeploySession> {
    ...
    create(value?: PartialMessage<HyperliquidWalletDeploySession>): HyperliquidWalletDeploySession {
        ...
        message.tokenWei = 0;
        message.tokenSupply = 0;
        message.startMarketCap = 0;
        message.spotPairId = 0;
        message.deployThreshold = 0;
        message.geneses = {};
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    ...
                    break;
                default: throw new globalThis.Error("unknown map entry field for hypurr.HyperliquidWalletDeploySession.geneses");
            }
        }
    ...
    internalBinaryWrite(message: HyperliquidWalletDeploySession, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of globalThis.Object.keys(message.geneses)) {
...
class PerformanceReport$Type extends MessageType<PerformanceReport> {
    ...
    create(value?: PartialMessage<PerformanceReport>): PerformanceReport {
        ...
        message.tokenId = 0;
        message.totalPnl = 0;
        message.runningPnl = 0;
        message.size = 0;
        message.price = 0;
        message.entryPrice = 0;
        message.totalCost = 0;
        message.runningCost = 0;
        if (value !== undefined)
...
class Performance$Type extends MessageType<Performance> {
    constructor() {
        super("hypurr.Performance", [
            ...
            { no: 2, name: "notional", kind: "scalar", T: 2 /*ScalarType.FLOAT*/ },
            { no: 3, name: "reports", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => PerformanceReport },
            { no: 4, name: "points", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => PerformancePoint }
        ]);
    }
