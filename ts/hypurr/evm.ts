...
export interface UniV2Pair {
    ...
    factory: string;
    /**
     * @generated from protobuf field: double volume0_24h = 8
     */
    volume024H: number; // 24h volume EMA for token0
    /**
     * @generated from protobuf field: double volume1_24h = 9
     */
...
export interface UniV3Pool {
    ...
    tick: number;
    /**
     * @generated from protobuf field: double volume0_24h = 10
     */
    volume024H: number; // 24h volume EMA for token0
    /**
     * @generated from protobuf field: double volume1_24h = 11
     */
    volume124H: number; // 24h volume EMA for token1
    /**
...
class ERC20Token$Type extends MessageType<ERC20Token> {
    ...
    create(value?: PartialMessage<ERC20Token>): ERC20Token {
        ...
        message.decimals = 0;
        message.totalSupply = "";
        message.priceInWhype = 0;
        message.volumeInWhype = 0;
        message.lastVolumeUpdate = 0;
        if (value !== undefined)
...
class UniV2Pair$Type extends MessageType<UniV2Pair> {
    ...
    create(value?: PartialMessage<UniV2Pair>): UniV2Pair {
        ...
        message.totalSupply = "";
        message.factory = "";
        message.volume024H = 0;
        message.volume124H = 0;
        message.lastVolumeUpdate = 0;
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string factory */ 7:
                    ...
                    break;
                case /* double volume0_24h */ 8:
                    message.volume024H = reader.double();
                    break;
                case /* double volume1_24h */ 9:
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int32 tick */ 9:
                    ...
                    break;
                case /* double volume0_24h */ 10:
                    message.volume024H = reader.double();
                    break;
                case /* double volume1_24h */ 11:
                    message.volume124H = reader.double();
                    break;
