...
/**
 * @generated from protobuf message hypurr.ERC20TokenBalance
 */
...
// @generated message type with reflection information, may provide speed optimized methods
class ERC20TokenBalance$Type extends MessageType<ERC20TokenBalance> {
    constructor() {
        super("hypurr.ERC20TokenBalance", [
            { no: 1, name: "contract_address", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "balance", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<ERC20TokenBalance>): ERC20TokenBalance {
        const message = { contractAddress: "", balance: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<ERC20TokenBalance>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ERC20TokenBalance): ERC20TokenBalance {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: ERC20TokenBalance, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
/**
 * @generated MessageType for protobuf message hypurr.ERC20TokenBalance
 */
export const ERC20TokenBalance = new ERC20TokenBalance$Type();
// @generated message type with reflection information, may provide speed optimized methods
