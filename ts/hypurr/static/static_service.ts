...
// tslint:disable
import { OnrampStorePermitResponse } from "../onramp";
import { OnrampStorePermitRequest } from "../onramp";
import { OnrampTxStatusResponse } from "../onramp";
import { OnrampTxStatusRequest } from "../onramp";
import { OnrampCheckoutUrlResponse } from "../onramp";
import { OnrampCheckoutUrlRequest } from "../onramp";
import { OnrampQuotesResponse } from "../onramp";
import { OnrampQuotesRequest } from "../onramp";
...
class HyperliquidTokenHoldersRequest$Type extends MessageType<HyperliquidTokenHoldersRequest> {
    constructor() {
        super("hypurr.HyperliquidTokenHoldersRequest", [
            { no: 1, name: "token_id", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int64 token_id */ 1:
                    message.tokenId = reader.int64().toBigInt();
                    break;
                default:
...
class HyperliquidLaunchesRequest$Type extends MessageType<HyperliquidLaunchesRequest> {
    constructor() {
        super("hypurr.HyperliquidLaunchesRequest", [
            { no: 1, name: "launch_ids", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
                ...
                case /* repeated int64 launch_ids */ 1:
                    if (wireType === WireType.LengthDelimited)
                        for (let e = reader.int32() + reader.pos; reader.pos < e;)
                            message.launchIds.push(reader.int64().toBigInt());
                    else
                        message.launchIds.push(reader.int64().toBigInt());
                    break;
                default:
...
class HyperliquidLaunchCandlesRequest$Type extends MessageType<HyperliquidLaunchCandlesRequest> {
    constructor() {
        super("hypurr.HyperliquidLaunchCandlesRequest", [
            { no: 1, name: "launch_id", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
...
class HpumpV1LaunchCandlesRequest$Type extends MessageType<HpumpV1LaunchCandlesRequest> {
    constructor() {
        super("hypurr.HpumpV1LaunchCandlesRequest", [
            ...
            { no: 2, name: "from_timestamp", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 3, name: "to_timestamp", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
    ...
    create(value?: PartialMessage<HpumpV1LaunchCandlesRequest>): HpumpV1LaunchCandlesRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.pairAddress = "";
        message.fromTimestamp = 0n;
        message.toTimestamp = 0n;
        message.interval = "";
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 from_timestamp */ 2:
                    message.fromTimestamp = reader.int64().toBigInt();
                    break;
                case /* int64 to_timestamp */ 3:
                    message.toTimestamp = reader.int64().toBigInt();
                    break;
...
class HypurrFunCabalPerformanceRequest$Type extends MessageType<HypurrFunCabalPerformanceRequest> {
    constructor() {
        super("hypurr.HypurrFunCabalPerformanceRequest", [
            { no: 1, name: "telegram_chat_id", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
    create(value?: PartialMessage<HypurrFunCabalPerformanceRequest>): HypurrFunCabalPerformanceRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.telegramChatId = 0n;
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int64 telegram_chat_id */ 1:
                    message.telegramChatId = reader.int64().toBigInt();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
...
class TelegramUserPublicRequest$Type extends MessageType<TelegramUserPublicRequest> {
    constructor() {
        super("hypurr.TelegramUserPublicRequest", [
            { no: 1, name: "telegram_id", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
...
export const Static = new ServiceType("hypurr.Static", [
    ...
    { name: "OnrampQuotes", options: {}, I: OnrampQuotesRequest, O: OnrampQuotesResponse },
    { name: "OnrampCheckoutUrl", options: {}, I: OnrampCheckoutUrlRequest, O: OnrampCheckoutUrlResponse },
    { name: "OnrampTxStatus", options: {}, I: OnrampTxStatusRequest, O: OnrampTxStatusResponse },
    { name: "OnrampStorePermit", options: {}, I: OnrampStorePermitRequest, O: OnrampStorePermitResponse }
]);
