...
class HyperliquidMostTrackedWalletsResponse$Type extends MessageType<HyperliquidMostTrackedWalletsResponse> {
    constructor() {
        super("hypurr.HyperliquidMostTrackedWalletsResponse", [
            { no: 1, name: "wallets", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => HyperliquidMostTrackedWallet }
        ]);
    }
...
class EVMSignTransactionRequest$Type extends MessageType<EVMSignTransactionRequest> {
    ...
    create(value?: PartialMessage<EVMSignTransactionRequest>): EVMSignTransactionRequest {
        const message = { authData: {}, walletId: 0, params: new Uint8Array(0) };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field hypurr.EVMSignTransactionRequest.auth_data");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
class EVMSignTransactionResponse$Type extends MessageType<EVMSignTransactionResponse> {
    ...
    create(value?: PartialMessage<EVMSignTransactionResponse>): EVMSignTransactionResponse {
        const message = { result: new Uint8Array(0) };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field hypurr.TelegramChatWalletPackCreateRequest.auth_data");
            }
        }
        map[key ?? ""] = val ?? "";
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field hypurr.HyperliquidWalletCreateRequest.auth_data");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
class HyperliquidWalletImportRequest$Type extends MessageType<HyperliquidWalletImportRequest> {
    ...
    create(value?: PartialMessage<HyperliquidWalletImportRequest>): HyperliquidWalletImportRequest {
        const message = { authData: {}, name: "", privateKey: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field hypurr.HyperliquidWalletImportRequest.auth_data");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
class HyperliquidWalletSetPublicRequest$Type extends MessageType<HyperliquidWalletSetPublicRequest> {
    ...
    create(value?: PartialMessage<HyperliquidWalletSetPublicRequest>): HyperliquidWalletSetPublicRequest {
        const message = { authData: {}, walletId: 0, public: false };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field hypurr.HyperliquidWalletSetPublicRequest.auth_data");
            }
        }
        map[key ?? ""] = val ?? "";
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field hypurr.HyperliquidAgentWalletRenewRequest.auth_data");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
class HyperliquidWalletUpdateRequest$Type extends MessageType<HyperliquidWalletUpdateRequest> {
    ...
    create(value?: PartialMessage<HyperliquidWalletUpdateRequest>): HyperliquidWalletUpdateRequest {
        const message = { authData: {}, walletId: 0, name: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field hypurr.HyperliquidWalletUpdateRequest.auth_data");
            }
        }
        map[key ?? ""] = val ?? "";
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field hypurr.PortfolioAllocatorGetRequest.auth_data");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
class PortfolioAllocatorListRequest$Type extends MessageType<PortfolioAllocatorListRequest> {
    ...
    create(value?: PartialMessage<PortfolioAllocatorListRequest>): PortfolioAllocatorListRequest {
        const message = { authData: {}, enabled: false };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field hypurr.PortfolioAllocatorListRequest.auth_data");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
class PortfolioAllocatorListResponse$Type extends MessageType<PortfolioAllocatorListResponse> {
    constructor() {
        super("hypurr.PortfolioAllocatorListResponse", [
            { no: 1, name: "allocators", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => PortfolioAllocator }
        ]);
    }
    create(value?: PartialMessage<PortfolioAllocatorListResponse>): PortfolioAllocatorListResponse {
        const message = { allocators: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field hypurr.PortfolioAllocatorSourceGetRequest.auth_data");
            }
        }
        map[key ?? ""] = val ?? "";
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field hypurr.PortfolioAllocatorSourceListRequest.auth_data");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
class PortfolioAllocatorSourceListResponse$Type extends MessageType<PortfolioAllocatorSourceListResponse> {
    constructor() {
        super("hypurr.PortfolioAllocatorSourceListResponse", [
            { no: 1, name: "sources", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => PortfolioSource }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field hypurr.PortfolioAllocatorCreateRequest.auth_data");
            }
        }
        map[key ?? ""] = val ?? "";
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field hypurr.PortfolioAllocatorUpdateRequest.auth_data");
            }
        }
        map[key ?? ""] = val ?? "";
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field hypurr.PortfolioAllocatorDeleteRequest.auth_data");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
class PortfolioAllocatorSourceCreateRequest$Type extends MessageType<PortfolioAllocatorSourceCreateRequest> {
    ...
    create(value?: PartialMessage<PortfolioAllocatorSourceCreateRequest>): PortfolioAllocatorSourceCreateRequest {
        const message = { authData: {}, walletId: 0, name: "", sourceType: "", weight: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field hypurr.PortfolioAllocatorSourceCreateRequest.auth_data");
            }
        }
        map[key ?? ""] = val ?? "";
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field hypurr.PortfolioAllocatorSourceUpdateRequest.auth_data");
            }
        }
        map[key ?? ""] = val ?? "";
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field hypurr.PortfolioAllocatorSourceDeleteRequest.auth_data");
            }
        }
        map[key ?? ""] = val ?? "";
    }
