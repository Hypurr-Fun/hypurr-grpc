...
class HyperliquidSpotSniperConfig$Type extends MessageType<HyperliquidSpotSniperConfig> {
    ...
    create(value?: PartialMessage<HyperliquidSpotSniperConfig>): HyperliquidSpotSniperConfig {
        ...
        message.name = "";
        message.targetToken = "";
        message.maxMarketCap = 0;
        message.maxNotional = 0;
        message.maxSlippage = 0;
        message.maxUserAllocation = 0;
        message.maxLiquidityAllocation = 0;
        message.maxAirdropAllocation = 0;
        message.enabled = false;
        message.antiRug = false;
        if (value !== undefined)
...
class HyperliquidWalletSpotTwapSession$Type extends MessageType<HyperliquidWalletSpotTwapSession> {
    ...
    create(value?: PartialMessage<HyperliquidWalletSpotTwapSession>): HyperliquidWalletSpotTwapSession {
        ...
        message.walletId = 0;
        message.pairId = 0;
        message.targetNotional = 0;
        message.filledQuantity = 0;
        message.filledCost = 0;
        message.duration = 0;
        message.enabled = false;
        message.buy = false;
        message.ended = false;
