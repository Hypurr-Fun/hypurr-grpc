...
import { OnrampPurchasesRequest } from "../onramp";
...
export interface HyperliquidLaunchTradeRequest {
    ...
    maxSlippage: number;
    /**
     * @generated from protobuf field: int64 signature_chain_id = 9
     */
...
/**
 * @generated from protobuf message eoa.EditHyperliquidLaunchRequest
 */
...
/**
 * @generated from protobuf message eoa.EditHyperliquidLaunchResponse
 */
...
/**
 * @generated from protobuf message eoa.LaunchHpumpV1LaunchRequest
 */
...
class HyperliquidLaunchTradeRequest$Type extends MessageType<HyperliquidLaunchTradeRequest> {
    constructor() {
        super("eoa.HyperliquidLaunchTradeRequest", [
            ...
            { no: 7, name: "time", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 8, name: "max_slippage", kind: "scalar", T: 1 /*ScalarType.DOUBLE*/ },
            { no: 9, name: "signature_chain_id", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* double max_slippage */ 8:
                    ...
                    break;
                case /* int64 signature_chain_id */ 9:
                    message.signatureChainId = reader.int64().toBigInt();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: HyperliquidLaunchTradeRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* int64 signature_chain_id = 9; */
        if (message.signatureChainId !== 0n)
            writer.tag(9, WireType.Varint).int64(message.signatureChainId);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class EOAToken$Type extends MessageType<EOAToken> {
    constructor() {
        super("eoa.EOAToken", [
            ...
            { no: 2, name: "expires_at", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
...
class EditHyperliquidLaunchRequest$Type extends MessageType<EditHyperliquidLaunchRequest> {
    constructor() {
        super("eoa.EditHyperliquidLaunchRequest", [
...
/**
 * @generated MessageType for protobuf message eoa.EditHyperliquidLaunchRequest
 */
...
class EditHyperliquidLaunchResponse$Type extends MessageType<EditHyperliquidLaunchResponse> {
    constructor() {
        super("eoa.EditHyperliquidLaunchResponse", [
            { no: 1, name: "launch", kind: "message", T: () => HyperliquidLaunch }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message eoa.EditHyperliquidLaunchResponse
 */
...
/**
 * @generated MessageType for protobuf message eoa.LaunchHpumpV1LaunchRequest
 */
...
export const EOA = new ServiceType("eoa.EOA", [
    ...
    { name: "OnrampPurchases", options: {}, I: OnrampPurchasesRequest, O: OnrampPurchasesResponse }
]);
