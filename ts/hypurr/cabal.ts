...
class HypurrFunCabal$Type extends MessageType<HypurrFunCabal> {
    constructor() {
        super("hypurr.HypurrFunCabal", [
            ...
            { no: 4, name: "users", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => HypurrFunCabalUser },
            { no: 5, name: "tracked_wallets", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => HypurrFunCabalTrackedWallet },
            { no: 6, name: "user_seasons", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => HypurrFunCabalUserSeason },
...
class HypurrFunCabalSummary$Type extends MessageType<HypurrFunCabalSummary> {
    ...
    create(value?: PartialMessage<HypurrFunCabalSummary>): HypurrFunCabalSummary {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.userCount = 0;
        message.seasonSpotPnl = 0;
        message.seasonPerpPnl = 0;
        message.seasonLaunchPnl = 0;
        if (value !== undefined)
...
class HypurrFunCabalTrackedWallet$Type extends MessageType<HypurrFunCabalTrackedWallet> {
    ...
    create(value?: PartialMessage<HypurrFunCabalTrackedWallet>): HypurrFunCabalTrackedWallet {
        ...
        message.walletId = 0;
        message.label = "";
        message.alertSpot = false;
        message.alertPerp = false;
        if (value !== undefined)
...
class HypurrFunCabalSeason$Type extends MessageType<HypurrFunCabalSeason> {
    constructor() {
        super("hypurr.HypurrFunCabalSeason", [
            ...
            { no: 5, name: "user_seasons", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => HypurrFunCabalUserSeason },
...
class HypurrFunCabalUserSeason$Type extends MessageType<HypurrFunCabalUserSeason> {
    ...
    create(value?: PartialMessage<HypurrFunCabalUserSeason>): HypurrFunCabalUserSeason {
        ...
        message.launchPnl = 0;
        message.perpPnl = 0;
        message.lastSpotPnl = 0;
        message.lastLaunchPnl = 0;
        message.lastPerpPnl = 0;
        if (value !== undefined)
...
class HypurrFunCabalPerformance$Type extends MessageType<HypurrFunCabalPerformance> {
    ...
    create(value?: PartialMessage<HypurrFunCabalPerformance>): HypurrFunCabalPerformance {
        ...
        message.launchPnl = 0;
        message.perpPnl = 0;
        message.seasonStartTime = 0;
        message.seasonEndTime = 0;
        if (value !== undefined)
...
class HypurrFunCabalAlert$Type extends MessageType<HypurrFunCabalAlert> {
    ...
    create(value?: PartialMessage<HypurrFunCabalAlert>): HypurrFunCabalAlert {
        ...
        message.sizeDelta = 0;
        message.costDelta = 0;
        message.positionSize = 0;
        message.positionEntryPrice = 0;
        message.positionPnl = 0;
        if (value !== undefined)
