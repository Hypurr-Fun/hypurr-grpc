...
class PortfolioAllocator$Type extends MessageType<PortfolioAllocator> {
    constructor() {
        super("hypurr.PortfolioAllocator", [
            ...
            { no: 8, name: "sources", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => PortfolioSource }
        ]);
    }
    create(value?: PartialMessage<PortfolioAllocator>): PortfolioAllocator {
        const message = { id: 0, telegramId: 0, walletId: 0, totalLeverage: 0, rebalanceInterval: 0, minRebalancePct: 0, enabled: false, sources: [] };
...
class PortfolioSource$Type extends MessageType<PortfolioSource> {
    ...
    create(value?: PartialMessage<PortfolioSource>): PortfolioSource {
        const message = { id: 0, allocatorId: 0, name: "", sourceType: "", weight: 0, enabled: false };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
