...
const (
	...
	HyperCore_WalletInstrumentMetrics_FullMethodName           = "/hypercore.HyperCore/WalletInstrumentMetrics"
)
...
type HyperCoreClient interface {
	...
	WalletInstrumentMetrics(ctx context.Context, in *WalletInstrumentMetricsRequest, opts ...grpc.CallOption) (*WalletInstrumentMetricsResponse, error)
}
...
func (c *hyperCoreClient) WalletInstrumentMetrics(ctx context.Context, in *WalletInstrumentMetricsRequest, opts ...grpc.CallOption) (*WalletInstrumentMetricsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WalletInstrumentMetricsResponse)
	err := c.cc.Invoke(ctx, HyperCore_WalletInstrumentMetrics_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HyperCoreServer interface {
	...
	WalletInstrumentMetrics(context.Context, *WalletInstrumentMetricsRequest) (*WalletInstrumentMetricsResponse, error)
...
func (UnimplementedHyperCoreServer) WalletInstrumentMetrics(context.Context, *WalletInstrumentMetricsRequest) (*WalletInstrumentMetricsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method WalletInstrumentMetrics not implemented")
}
...
func _HyperCore_WalletInstrumentMetrics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WalletInstrumentMetricsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HyperCoreServer).WalletInstrumentMetrics(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HyperCore_WalletInstrumentMetrics_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HyperCoreServer).WalletInstrumentMetrics(ctx, req.(*WalletInstrumentMetricsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HyperCore_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "WalletInstrumentMetrics",
			Handler:    _HyperCore_WalletInstrumentMetrics_Handler,
		},
	},
