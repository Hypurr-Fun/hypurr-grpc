...
const (
	MediaType_MEDIA_TYPE_IMAGE     MediaType = 0
...
type LaunchHyperliquidLaunchRequest struct {
	...
	InitialNotional  float64           `protobuf:"fixed64,9,opt,name=initial_notional,json=initialNotional,proto3" json:"initial_notional,omitempty"`
}
...
func (x *LaunchHyperliquidLaunchRequest) GetInitialNotional() float64 {
	if x != nil {
		return x.InitialNotional
	}
	return 0
}
...
var file_hypurr_telegram_service_proto_rawDesc = []byte{
	...
	0x22, 0xcc, 0x03, 0x0a, 0x1e, 0x4c, 0x61, 0x75, 0x6e, 0x63, 0x68, 0x48, 0x79, 0x70, 0x65, 0x72,
	...
	0x53, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x73, 0x12, 0x29, 0x0a, 0x10, 0x69, 0x6e, 0x69, 0x74, 0x69,
	0x61, 0x6c, 0x5f, 0x6e, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x18, 0x09, 0x20, 0x01, 0x28,
	0x01, 0x52, 0x0f, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x6c, 0x4e, 0x6f, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x00, 0x12, 0x08, 0x0a, 0x04, 0x53, 0x45, 0x4c, 0x4c, 0x10, 0x01, 0x2a, 0x51, 0x0a, 0x09, 0x4d,
	0x65, 0x64, 0x69, 0x61, 0x54, 0x79, 0x70, 0x65, 0x12, 0x14, 0x0a, 0x10, 0x4d, 0x45, 0x44, 0x49,
	0x41, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x49, 0x4d, 0x41, 0x47, 0x45, 0x10, 0x00, 0x12, 0x18,
	0x0a, 0x14, 0x4d, 0x45, 0x44, 0x49, 0x41, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x41, 0x4e, 0x49,
	0x4d, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x10, 0x01, 0x12, 0x14, 0x0a, 0x10, 0x4d, 0x45, 0x44, 0x49,
	0x41, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x56, 0x49, 0x44, 0x45, 0x4f, 0x10, 0x02, 0x32, 0xa8,
	0x09, 0x0a, 0x08, 0x54, 0x65, 0x6c, 0x65, 0x67, 0x72, 0x61, 0x6d, 0x12, 0x4b, 0x0a, 0x0c, 0x54,
...
var file_hypurr_telegram_service_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
var file_hypurr_telegram_service_proto_goTypes = []any{
	...
	nil,                                               // 22: hypurr.TelegramUserRequest.AuthDataEntry
	nil,                                               // 23: hypurr.TelegramUserWalletsRequest.AuthDataEntry
	nil,                                               // 24: hypurr.HyperliquidLaunchTradeRequest.AuthDataEntry
	nil,                                               // 25: hypurr.HyperliquidSpotTradeRequest.AuthDataEntry
	nil,                                               // 26: hypurr.HyperliquidSpotSniperConfigsRequest.AuthDataEntry
	nil,                                               // 27: hypurr.DeleteHyperliquidSpotSniperConfigRequest.AuthDataEntry
	nil,                                               // 28: hypurr.CreateHyperliquidSpotSniperConfigRequest.AuthDataEntry
	nil,                                               // 29: hypurr.UpdateHyperliquidSpotSniperConfigRequest.AuthDataEntry
	nil,                                               // 30: hypurr.HyperliquidWalletSpotTwapSessionsRequest.AuthDataEntry
	nil,                                               // 31: hypurr.LaunchHyperliquidLaunchRequest.AuthDataEntry
	(*TelegramUser)(nil),                              // 32: hypurr.TelegramUser
	(*HyperliquidWallet)(nil),                         // 33: hypurr.HyperliquidWallet
	(*HyperliquidSpotSniperConfig)(nil),               // 34: hypurr.HyperliquidSpotSniperConfig
	(*HyperliquidWalletSpotTwapSession)(nil),          // 35: hypurr.HyperliquidWalletSpotTwapSession
	(*HyperliquidLaunch)(nil),                         // 36: hypurr.HyperliquidLaunch
}
var file_hypurr_telegram_service_proto_depIdxs = []int32{
	22, // 0: hypurr.TelegramUserRequest.auth_data:type_name -> hypurr.TelegramUserRequest.AuthDataEntry
	32, // 1: hypurr.TelegramUserResponse.user:type_name -> hypurr.TelegramUser
	23, // 2: hypurr.TelegramUserWalletsRequest.auth_data:type_name -> hypurr.TelegramUserWalletsRequest.AuthDataEntry
	33, // 3: hypurr.TelegramUserWalletsResponse.wallets:type_name -> hypurr.HyperliquidWallet
	24, // 4: hypurr.HyperliquidLaunchTradeRequest.auth_data:type_name -> hypurr.HyperliquidLaunchTradeRequest.AuthDataEntry
	0,  // 5: hypurr.HyperliquidLaunchTradeRequest.direction:type_name -> hypurr.HyperliquidLaunchTradeDirection
	25, // 6: hypurr.HyperliquidSpotTradeRequest.auth_data:type_name -> hypurr.HyperliquidSpotTradeRequest.AuthDataEntry
	0,  // 7: hypurr.HyperliquidSpotTradeRequest.direction:type_name -> hypurr.HyperliquidLaunchTradeDirection
	26, // 8: hypurr.HyperliquidSpotSniperConfigsRequest.auth_data:type_name -> hypurr.HyperliquidSpotSniperConfigsRequest.AuthDataEntry
	34, // 9: hypurr.HyperliquidSpotSniperConfigsResponse.configs:type_name -> hypurr.HyperliquidSpotSniperConfig
	27, // 10: hypurr.DeleteHyperliquidSpotSniperConfigRequest.auth_data:type_name -> hypurr.DeleteHyperliquidSpotSniperConfigRequest.AuthDataEntry
	28, // 11: hypurr.CreateHyperliquidSpotSniperConfigRequest.auth_data:type_name -> hypurr.CreateHyperliquidSpotSniperConfigRequest.AuthDataEntry
	34, // 12: hypurr.CreateHyperliquidSpotSniperConfigRequest.config:type_name -> hypurr.HyperliquidSpotSniperConfig
	34, // 13: hypurr.CreateHyperliquidSpotSniperConfigResponse.config:type_name -> hypurr.HyperliquidSpotSniperConfig
	29, // 14: hypurr.UpdateHyperliquidSpotSniperConfigRequest.auth_data:type_name -> hypurr.UpdateHyperliquidSpotSniperConfigRequest.AuthDataEntry
	34, // 15: hypurr.UpdateHyperliquidSpotSniperConfigRequest.config:type_name -> hypurr.HyperliquidSpotSniperConfig
	30, // 16: hypurr.HyperliquidWalletSpotTwapSessionsRequest.auth_data:type_name -> hypurr.HyperliquidWalletSpotTwapSessionsRequest.AuthDataEntry
	35, // 17: hypurr.HyperliquidWalletSpotTwapSessionsResponse.sessions:type_name -> hypurr.HyperliquidWalletSpotTwapSession
	31, // 18: hypurr.LaunchHyperliquidLaunchRequest.auth_data:type_name -> hypurr.LaunchHyperliquidLaunchRequest.AuthDataEntry
	1,  // 19: hypurr.LaunchHyperliquidLaunchRequest.media_type:type_name -> hypurr.MediaType
	36, // 20: hypurr.LaunchHyperliquidLaunchResponse.launch:type_name -> hypurr.HyperliquidLaunch
	2,  // 21: hypurr.Telegram.TelegramUser:input_type -> hypurr.TelegramUserRequest
	4,  // 22: hypurr.Telegram.TelegramUserWallets:input_type -> hypurr.TelegramUserWalletsRequest
	6,  // 23: hypurr.Telegram.HyperliquidLaunchTrade:input_type -> hypurr.HyperliquidLaunchTradeRequest
	20, // 24: hypurr.Telegram.LaunchHyperliquidLaunch:input_type -> hypurr.LaunchHyperliquidLaunchRequest
	8,  // 25: hypurr.Telegram.HyperliquidSpotTrade:input_type -> hypurr.HyperliquidSpotTradeRequest
	18, // 26: hypurr.Telegram.HyperliquidWalletSpotTwapSessions:input_type -> hypurr.HyperliquidWalletSpotTwapSessionsRequest
	10, // 27: hypurr.Telegram.HyperliquidSpotSniperConfigs:input_type -> hypurr.HyperliquidSpotSniperConfigsRequest
	14, // 28: hypurr.Telegram.CreateHyperliquidSpotSniperConfig:input_type -> hypurr.CreateHyperliquidSpotSniperConfigRequest
	12, // 29: hypurr.Telegram.DeleteHyperliquidSpotSniperConfig:input_type -> hypurr.DeleteHyperliquidSpotSniperConfigRequest
	16, // 30: hypurr.Telegram.UpdateHyperliquidSpotSniperConfig:input_type -> hypurr.UpdateHyperliquidSpotSniperConfigRequest
	3,  // 31: hypurr.Telegram.TelegramUser:output_type -> hypurr.TelegramUserResponse
	5,  // 32: hypurr.Telegram.TelegramUserWallets:output_type -> hypurr.TelegramUserWalletsResponse
	7,  // 33: hypurr.Telegram.HyperliquidLaunchTrade:output_type -> hypurr.HyperliquidLaunchTradeResponse
	21, // 34: hypurr.Telegram.LaunchHyperliquidLaunch:output_type -> hypurr.LaunchHyperliquidLaunchResponse
	9,  // 35: hypurr.Telegram.HyperliquidSpotTrade:output_type -> hypurr.HyperliquidSpotTradeResponse
	19, // 36: hypurr.Telegram.HyperliquidWalletSpotTwapSessions:output_type -> hypurr.HyperliquidWalletSpotTwapSessionsResponse
	11, // 37: hypurr.Telegram.HyperliquidSpotSniperConfigs:output_type -> hypurr.HyperliquidSpotSniperConfigsResponse
	15, // 38: hypurr.Telegram.CreateHyperliquidSpotSniperConfig:output_type -> hypurr.CreateHyperliquidSpotSniperConfigResponse
	13, // 39: hypurr.Telegram.DeleteHyperliquidSpotSniperConfig:output_type -> hypurr.DeleteHyperliquidSpotSniperConfigResponse
	17, // 40: hypurr.Telegram.UpdateHyperliquidSpotSniperConfig:output_type -> hypurr.UpdateHyperliquidSpotSniperConfigResponse
